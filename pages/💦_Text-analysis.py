...
def main():
    ...
    with tabs[0]:  # Word Count tab
        ...
        st.caption("This application will display the number of words and sentences in your text. After pasting your text in the box below, hit Control + Enter key to see the result. [241101]")
