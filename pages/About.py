...
def main():
    ...
    with tabs[0]:
        ...
        st.markdown("\n\n")
        st.markdown("〽️ Linguist (Phonetics/Phonology) & educator")
        st.markdown("〽️ Github ID: MK316")
        st.markdown("〽️ Affiliation: Dept. of English Education, GNU ⛺ [Goto](https://englishedu.gnu.ac.kr)")
        st.markdown("〽️ Archives (before 10. 14. 2024) - My digital classroom: [mrkim21.github.io](https://mrkim21.github.io)")
